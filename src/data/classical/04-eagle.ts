...
//   Google Sheet (no author named on the sheet; its grades agree with the
//   independently cited Utkatasana 2 and Utthita Trikonasana 3):
...
//   (plate-number index by asana family; no grades)
...
// - https://adventureyogaonline.com/garudasana-benefits/ (credits Light on
//   Yoga for the modern pose; its step-by-step wraps the legs first, then arms)
// - https://www.ihanuman.com/asana/garudasana (opposite-side pairing;
//   Vrksasana and Gomukhasana among the preparations; toe-on-floor, wall,
//   seated and strap modifications)
export const eagle: ClassicalNote = {
  asana: 'Garudasana',
  asanaEnglish: 'Eagle Pose',
  etymology:
    'Garuda is the eagle of Hindu myth — king of the birds and the mount of Vishnu, a name traditionally traced to a root meaning “to devour”, from an old identification of the bird with the sun, which swallows up whatever it shines on — and asana is “a seat” or “posture”. The name is older than the shape: the seventeenth-century Gheranda Samhita gives Garudasana to a grounded pose with the hands on the knees, a nineteenth-century Mysore manual to a one-legged balance nearer to tree, and the standing wrap you practise is the modern form, the one Light on Yoga records.',
  reference: { plates: '56', difficulty: 1 },
  contrast:
    'This is one of the rare places where the two lineages share both a name and a shape: Iyengar’s Garudasana is the same braid of limbs, filed at plate 56 and graded 1 — the easiest rung of his sixty. Light on Yoga starts it from Tadasana, bends the standing knee — a modified Utkatasana, as Iyengar teachers describe the base — and wraps the legs before the arms; 26 & 2 wraps the arms first, then sits low as if into a chair and lifts the leg over last, because in a heated room the deep sit is what makes the hook available, and the compression it creates — the “fourteen joints” teaching, which is Ghosh-lineage and not a claim Light on Yoga makes — is the point of the posture. In both, the arm that crosses on top is on the opposite side from the leg on top, so the body is braided rather than merely stacked. Iyengar’s hold is a single, longer one on each side, and Iyengar teachers also give the arm wrap on its own, standing in Tadasana or seated in Virasana; 26 & 2 gives you two short counted sets, elbows pulled down and fingers under the nose, and lets the repetition do what a longer hold would. His very next entry, Vatayanasana, carries the same arms into a kneeling half lotus and jumps to grade 11 — a reminder of how far this beginner’s shape can travel.',
  refinements: [
    ...
    'Keep the trunk rising while the hips sink — the rule the Iyengar method applies to Utkatasana: lift the sternum and lengthen the side ribs up out of the pelvis, and the low sit stays a sit rather than a slump forward into the arms.',
  ],
  stages: [
