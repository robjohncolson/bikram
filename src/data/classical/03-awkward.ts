...
//   above the usual / fierce; the chair-shaped modern pose is attributed,
//   with hedging, to Krishnamacharya; a low squat in medieval hatha yoga;
//   the Sritattvanidhi shows it as a squat close to Upaveshasana; Ardha /
//   Parivrtta variants)
...
//   dictionary gloss of utkata: immense, superior)
...
// - https://en.wikipedia.org/wiki/Malasana (Light on Yoga Malasana, p. 266;
//   the Western "Malasana" is really Upaveshasana; Prapadasana is the
//   heels-together tiptoe variant)
...
export const awkward: ClassicalNote = {
  ...
  etymology:
    'Utkata is a Sanskrit adjective for something raised above the ordinary — fierce, intense, immense, and by extension wild, haughty, or uneven — and asana is a seat or posture, so Utkatasana is the fierce seat. “Awkward” is the 26 & 2 rendering of that same root, keeping its sense of uneven and out of the usual; “Chair” is a modern nickname for the shape rather than a translation of anything.',
  ...
  stages: [
    ...
    'Part three to a halfway hover only — heels up, knees together, spine long — letting the full 26 & 2 hover just above the heels be a depth the knees earn over weeks, never today’s requirement; the Gheranda Samhita’s seat resting on the heels is the shape’s textual ancestor, not a place to sit down into.',
  ],
  ladder: {
    before: [
      'Tadasana (Mountain)',
