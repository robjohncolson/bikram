...
export const locust: ClassicalNote = {
  ...
  etymology:
    'Śalabha is Sanskrit for a locust or grasshopper — the raised legs are the insect’s lifted hindquarters — and asana is “a seat” or “posture”; ardha means “half”, so a one-leg-at-a-time locust is Ardha Salabhasana, and pūrṇa means “complete”, the word 26 & 2 saves for the next posture. The name is younger than it sounds: no medieval hatha text describes the pose, it first appears in print in a 1905 illustrated Indian manual, and the Sivananda school (1960) and Light on Yoga (1966) recorded it independently within a few years of each other.',
  reference: { plates: '60–61', difficulty: 1 },
  contrast:
    'Iyengar’s Salabhasana is the everything-off-the-floor form: the arms reach straight back beside the body and lift, the head and chest rise, both straight legs rise, and only the abdomen touches the floor — filed at plates 60–61, graded 1 of his sixty, and placed in Light on Yoga before Cobra rather than after it. 26 & 2 practises a different architecture, the one the Sivananda schools also teach: arms pinned under the body, chin reaching forward along the floor, one leg lifted at a time and then both — a staged half form that Wikipedia files under Ardha Salabhasana and that Light on Yoga never lists as a separate entry. The reason is the lever: with the palms pressing down beneath the hips the arms become a fulcrum, the legs can rise far higher than an unassisted back could raise them, and the anchored chin and chest isolate the work in the hips and low back — the counted, single-region strength this sequence wants banked before Full Locust asks the whole body to fly. Iyengar removes the fulcrum on purpose: with nothing under you the lift is smaller, but the whole back body from the nape to the heels has to fire at once, which is why his method treats this grade-1 shape as the place you first learn to lift against gravity before Dhanurasana (grade 4). Teachers in the Iyengar method hold it briefly and describe it as a burst of strength rather than an endurance pose, where 26 & 2 gives you three separate lifts on a count; and the shape travels a long way from here — 26 & 2’s own Full Locust is a Salabhasana variation with the arms swung out into wings, Makarasana on the next page clasps the hands behind the head, and Viparita Salabhasana, the locust turned upside down to balance on chin and chest, sits near the top of the scale at grade 58.',
  refinements: [
  ...
  stages: [
    'Upper body only, legs resting on the floor: arms alongside you, lift the head, chest and hands and reach back through the fingers while the breastbone reaches forward — the Iyengar first stage, learning to lift from the back with nothing under you.',
