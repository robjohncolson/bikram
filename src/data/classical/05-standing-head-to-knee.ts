...
//   UHP II without support carries no Light on Yoga plate)
...
//   "stage 1 hands holding the foot, stage 2 head to knee" — all Form I, leg to
//   the front; the side form II is cited only to Gem plate 123)
...
export const standingHeadToKnee: ClassicalNote = {
  ...
  etymology:
    'Daṇḍa is a staff or rod, and daṇḍāyamāna is the participle of a verb built on it — to stand erect like a staff, to be stem-like — which the Ghosh lineage renders simply as “standing” (the studio gloss that splits it into danda, “stick”, and yamana, “balancing”, is a memorable mnemonic rather than the grammar of the word); jānu is the knee, śīrṣa the head, āsana the seat. Iyengar’s Jānu Śīrṣāsana is a seated forward bend, so the 26 & 2 name reads as “that pose, done standing like a staff” — but the shape itself lives under a different classical name: utthita (extended), hasta (hand), pāda (foot) and aṅguṣṭha (big toe), the extended hand-to-big-toe pose.',
  reference: { plates: '20–23', difficulty: 16 },
  contrast:
    'In Light on Yoga the nearest form is Utthita Hasta Padangusthasana — plates 20 to 23, graded 16, a long way above Tree at 1 or Triangle at 3 — and Iyengar builds it out of Tadasana with one hand: the same-side hand takes the big toe in a two-finger-and-thumb lock, the other hand rests on the hip, the leg straightens forward, and in a second stage the head comes down to the knee; the second form that swings the straight leg out to the side lives in the wider Iyengar syllabus rather than under these plates. 26 & 2 rebuilds the pose around a different grip and a different rule: all ten fingers interlaced under the ball of a flexed foot, so the arms can pull hard against a leg that is kicking its heel away, and a locked standing knee that is the gate to every stage — the toe-lock and hip-hand of the Iyengar form are alignment instruments, while the ten-finger grip is a strength instrument that turns the hold into two working legs. The Iyengar syllabi introduce the pose with the foot resting on a ledge — and Iyengar teachers add a belt round the foot when the hamstrings are short — before the free-standing form, and reach the head-to-knee stage from a lengthened trunk; 26 & 2 meets it in a heated room in two counted sets of a minute and half a minute, adds the elbows-down, chin-tucked curl as its own final gate, and leaves the leg-to-the-side form out entirely, that lateral hip work going to other postures in the series. Neither lineage can claim the pose as ancient: it is absent from the medieval hatha texts and turns up in India only in the 1920s, so Ghosh’s and Krishnamacharya’s students inherited the same young shape and built it into two different disciplines.',
  refinements: [
    ...
    'Extend from the hip socket, not the arms. Settle the thigh bone back into its socket, then push the heel away and draw the kneecap back toward you — the 26 & 2 kick into an imaginary wall — so the arms pull against what the leg gives rather than hauling the leg up by the foot.',
  ...
  stages: [
    ...
    'The 26 & 2 first stage — standing knee locked, the held foot in the ten-finger grip with that knee bent — near a wall if the balance is unsteady, as Iyengar teachers do with their own bent-knee stage; a complete posture until the kick-out is ready.',
