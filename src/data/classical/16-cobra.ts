...
// - https://loyindex.org → "Asana Indexes for Light on Yoga", a published Google
//   Sheet (a searchable index by Steve Barber, linked from a comment on Eyal
//   Shifroni's Light on Yoga index post; no author is named on the sheet itself):
