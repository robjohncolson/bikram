...
export const tree: ClassicalNote = {
  ...
  refinements: [
    ...
    'Make the foot stay by pressure, not grip: the sole presses into the inner thigh and the thigh presses back into the sole, toes aimed at the floor. In the Iyengar method that two-way press is what holds the foot once the hand lets go — practise it while your hand is still there, and the release becomes an afterthought.',
    ...
    'Fix the eyes on one unmoving point at eye level and keep the breath even; Iyengar teachers treat the pose as a practice of concentration as much as a hip opener, and the balance follows the gaze.',
  ],
  stages: [
    ...
    'The classical finish, for practice outside class: from the same balance, press the palms together and send the arms up alongside the ears, breathing evenly for twenty to thirty seconds; once that is steady, Iyengar-lineage teachers progress to closing the eyes.',
  ],
  ladder: {
    before: [
      'Tadasana (Mountain)',
