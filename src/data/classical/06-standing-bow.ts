...
//   553–557 / 43; Kapotasana 507–512; Urdhva Dhanurasana I 479–482 / 7;
//   Tadasana plate 1 / 1; Vrksasana plate 2 / 1)
...
export const standingBow: ClassicalNote = {
  ...
  etymology:
    'Danda is a staff or rod, and dandayamana — the word this lineage attaches to its standing balances — means “held like a staff”, straight and unbending; dhanu is a bow and asana “a seat” or “posture”, so Dandayamana-Dhanurasana is simply the bow pose stood up on one leg. Iyengar files the standing shape under a different name altogether: nata is a dancer, raja a king, and Nataraja is Shiva as the cosmic dancer, whose dancing figures cover the temple at Chidambaram — so Natarajasana is the pose of the lord of the dance. Neither name is old: the medieval hatha texts describe a bow but no standing version of it, and the one-legged dancer entered yoga in the twentieth century through Krishnamacharya before Light on Yoga made it famous.',
  reference: { plates: '587–591', difficulty: 58 },
  contrast:
    'Light on Yoga keeps the bow on the floor — Dhanurasana is the prone backbend at plate 63, graded 4 — and puts the one-legged standing bow at the far end of the book as Natarajasana, graded 58, the second-highest mark on Iyengar’s scale. That grade belongs to the finish, where the trunk stays lifted and the elbow rotates up and back until both hands hold the foot overhead and draw it toward the crown; the entry walks up to it from the one-handed grip with the other arm reaching forward, which is the shape most modern classes call dancer pose and the nearest relative of the one you practise. 26 & 2 takes that stage, makes it the whole posture, and changes its direction: rather than staying upright and pulling the foot in, you tip the trunk toward parallel and kick back and up until the foot rises over your head, the reaching arm and the kicking leg drawing the bow between them. The room and the count explain the choice — a heated body can go for full hip extension quickly, and a sixty-second hold rewards a shape that can be pushed further every second over one that is settled into once. Iyengar’s version is a still balance measured by how far the foot comes overhead; the 26 & 2 version is a moving one measured by how much kick your grip and your standing leg can absorb — the same bow, drawn from opposite ends.',
  refinements: [
  ...
  stages: [
    ...
    'Kick only until the thigh is level with the hip, trunk still upright and chest lifted — the settled, chest-up stage; hold it steady before adding any forward reach.',
    ...
    'Beyond class, the classical finish: rotate the elbow up and back, then bring the second hand to the foot overhead — Iyengar’s plates 590–591, and not a shape to hunt for inside a counted hold.',
  ],
  ladder: {
    before: [
      'Tadasana (Mountain)',
