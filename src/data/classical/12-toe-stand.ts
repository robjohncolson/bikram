...
//   Pādāṅguṣṭhāsana; the table's own "nearest equivalent in other schools"
//   column gives Malasana)
...
export const toeStand: ClassicalNote = {
  asana: null,
  etymology:
    'Pada is the foot, angustha the big toe (Sanskrit uses one word for the big toe and the thumb) and asana a seat or posture — a big-toe pose, and 26 & 2 earns the name literally by standing you on the ball of one foot with the toes spread into the floor. In Light on Yoga the same name belongs to a different shape entirely: Iyengar’s Padangusthasana (plates 43–44, graded 3) is a standing forward bend in which the fingers hook the big toes, so the classical name promises a hand-to-foot pose, and the toe stand never brings a hand near the foot — here the toe is the ground you balance on, not the thing you hold. The shape’s older name is arguably Utkatasana, from utkata, “intense, towering, fierce”: the seventeenth-century Gheranda Samhita gives that name to a squat with only the toes on the ground, heels in the air and the seat resting on them — the toe stand’s balance point, more than two centuries before “Utkatasana” came to mean a chair.',
  contrast:
    'Light on Yoga has no toe stand, so the classical view of this posture is triangulated from three neighbours rather than read off one plate; the nearest thing in Iyengar’s book is Vatayanasana (plates 57–59, graded 11): the same half lotus over the same bending standing leg, but the folded knee is lowered all the way to the floor on a flat standing foot and the arms wrap as in Eagle — a kneeling pose that trades the ball-of-the-foot balance for a deeper ask of the hip and knee, and one Iyengar himself notes is testing for the knees and the balance at first. Wikipedia’s table of the Bikram postures names Malasana as the nearest equivalent in other schools, and the resemblance is the squat: Iyengar’s Malasana II (plate 322, graded 2) squats heels-down and folds forward with the hands round the heels and the chin toward the floor, while Malasana I (plates 317–321, graded 8) wraps the arms round the legs and clasps the hands behind the back — the garland of the name is, in Iyengar’s reading, the arms hanging like one — so both keep the heels grounded and fold forward, exactly where the toe stand lifts the heel and keeps the spine upright, which makes the truer two-footed cousin the tiptoe squat the modern repertoire calls Prapadasana, a pose Light on Yoga leaves out. Even your way in has a classical name: half lotus, fold forward, fingertips to the floor is Ardha Baddha Padmottanasana (plates 50–55, graded 9) without its bind — Iyengar keeps the standing leg straight and stays in the fold, where 26 & 2 bends that leg and sinks through it. The differences are choices, not corrections: the Iyengar squats keep the heels grounded because what they are after is length in the ankles, groins and back (a heel that will not reach the floor is, in that method, propped rather than left to float), while 26 & 2 lifts the heel on purpose, because a raised heel turns a stretch into a balance — total control on the way to the floor, held by one fixed gaze in a room hot enough to make the deep half-lotus squat available — and that balance is what the twelfth posture is for. The holds differ too: Iyengar’s Vatayanasana is a single still hold of about thirty seconds a side, while 26 & 2 gives roughly forty seconds a side and counts the descent and the rise as part of the posture.',
  refinements: [
    'Build the standing foot the way Iyengar builds Tadasana — his two-footed mountain, not our Tree — before the heel ever lifts: toes spread, the mound of the big toe and the mound of the little toe both pressing, the ankle centred over the ball of the foot. Once the heel rises the ball of the foot is your entire ground, so keep the big-toe mound heavy — the moment it lightens the ankle rolls outward and the balance goes with it.',
  ...
  stages: [
    ...
    'The complete form: seat on the heel, spine tall, palms together at the chest, gaze welded to its spot on the floor — and, giving the way out the same attention the Iyengar method gives the way in, rising back to Tree as slowly as you came down.',
  ],
  ladder: {
    before: [
      'Tadasana (Mountain)',
